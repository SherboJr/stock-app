...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStockData = async () => {
      try {
        const response = await fetch("/pages/api/tkr");
      ...
      {loading ? (
        ...
        <div className="">
          <div className=" flex flex-row bg-slate-900 w-full h-20">
            <img src="/pepe.jpg" alt="pepe" className=" h-8 w-8 ml-4 mt-3 " />
            <div className="text-2xl font-mono text-white ml-4 pt-3 ">
              Nasdaq
            </div>
          </div>
